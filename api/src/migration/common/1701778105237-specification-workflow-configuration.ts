            ...
            ----------------------------------------------Insert 'Specification' details in jms_dtl_workflow_config table--------------------------------------
                ...
                BEGIN
                    ...
                    BEGIN
                        ...
                        VALUES
                            (1, 'RAISE', 'Draft', 'Create New', 0, 0, null,'["proj_drd_specification_raise_office"]'),
                            (2, 'IN PROGRESS', 'Update Spec', 'Update Spec', 1, 0, 1,'["proj_drd_specification_in_progress_office"]'),
                            (3, 'COMPLETE', 'Complete Spec', 'Completed', 1, 0, 1,'["proj_drd_specification_complete_office"]'),
                            (4, 'VERIFY', NULL, NULL, 0, 0, 1,'["proj_drd_specification_verify_office"]'),
                            (5, 'REVIEW', NULL, NULL, 0, 0, 1,'["proj_drd_specification_review_office"]'),
                            (6, 'APPROVE', 'Approve', 'Approved', 1, 1, 1, '["proj_drd_specification_approve_office"]'),
                            (7, 'CLOSE', 'Close', 'Closed', 1, 1, 1,'["proj_drd_specification_close_office"]'),
                            (8, 'UNCLOSE', 'Reopen', 'N/A', 1, 0, 1,'["proj_drd_specification_unclose_office"]')
                                        ...
                                        BEGIN
                                            BEGIN TRY
                                                ...
                                                IF(@Config_Details_Id > 0)
                                                    ...
                                                    BEGIN
                                                    Set @Active_Status = 1
                                                    SET @right_code='["proj_drd_specification_raise_office"]'
                                                    END
                                                    ELSE IF (@Is_Office =0)
                                                    BEGIN
                                                    Set @Active_Status = 0
                                                    SET @right_code='["proj_drd_specification_raise_vessel"]'
                                                    END
