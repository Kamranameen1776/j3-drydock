...
export class specificationDetailsAccessRights1709113637662 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        try {
            ...
            USING (VALUES
                       ...
                       ('0DCFF97C-003B-46DB-AB81-195F8E2CA7CB', 'add_sub_items', 'Add sub items access rights for specification', 'o', 'project', 'specification_details', 'add_sub_items', 1, getdate(), 1, NULL, 1, 'add_sub_items	Add Sub Items in Specification', NULL),
                       ...
                       ('4A43BEE2-B4F6-40F1-B506-48F9660E9B92', 'edit_general_information', 'Edit general information access rights for specification', 'o', 'project', 'specification_details', 'edit_general_information', 1, getdate(), 1, NULL, 1, 'Edit General Information in Specification', NULL),
                       ...
                       ('52BE32D8-C661-4D58-8A29-5A0EBDEE6068', 'delete_specification_detail', 'Delete specification detail', 'o', 'project', 'specification_details', 'delete', 1, getdate(), 1, NULL, 1, 'Delete Specification Detail', NULL),
                       ('8EC05117-9F98-44F8-9C27-5F42AB0EF41F', 'view_findings_section', 'View Findings Section in Specification', 'o', 'project', 'specification_details', 'view_findings_section', 1, getdate(), 1, NULL, 1, 'View Findings in Specification', NULL),
                       ('542D4F69-361B-4611-9EB8-675B5078A58D', 'view_specification_detail', 'View specification detail page', 'o', 'project', 'specification_details', 'view_spec', 1, getdate(), 1, NULL, 1, 'View Specification Detail', NULL),
                       ...
                       ('F098C80B-FE09-4E7B-88FB-73DB3B084178', 'edit_header_section', 'Edit header section in specification', 'o', 'project', 'specification_details', 'edit_header_section', 1, getdate(), 1, NULL, 1, 'Edit Header Section of Specification', NULL),
                       ...
                       ('29FB7EFE-83E3-495C-AB06-7E0B693E3936', 'edit_attachments', 'Edit attachments rights for specification', 'o', 'project', 'specification_details', 'edit_attachments', 1, getdate(), 1, NULL, 1, 'Edit Attachments in Specification', NULL),
                       ('11C1DDC8-8D36-48BE-A4E2-6CBF416E4F97', 'delete_sub_items', 'Delete sub items access rights for specification', 'o', 'project', 'specification_details', 'delete_sub_items', 1, getdate(), 1, NULL, 1, 'Delete Sub Items in Specification', NULL),
                       ...
                       ('E78179A6-1FA3-47D8-91AC-8F8AE3C3509F', 'add_attachments', 'Add attachments rights for specification', 'o', 'project', 'specification_details', 'add_attachments', 1, getdate(), 1, NULL, 1, 'Add Attachments in Specification', NULL),
                       ...
                       ('EF48B6A0-B199-45E6-9283-95D21304EF5E', 'delete_attachments', 'Delete attachment rights for specification', 'o', 'project', 'specification_details', 'delete_attachments', 1, getdate(), 1, NULL, 1, 'Delete Attachment in Specification', NULL),
                       ('0B404328-13A0-4312-A8A1-982544A4DBBE', 'view_sub_items_section', 'View Sub Items Section in Specification', 'o', 'project', 'specification_details', 'view_sub_items_section', 1, getdate(), 1, NULL, 1, 'View Sub Items in Specification', NULL),
                       ...
                       ('E23AB67E-6A5D-4CFA-BF7B-CE1D9A879AF8', 'view_general_information_section', 'View General Information Section in Specification', 'o', 'project', 'specification_details', 'view_gen_info_section', 1, getdate(), 1, NULL, 1, 'View General Information in Specification', NULL),
                       ...
                       ('899C004D-135B-4AEB-96EF-FF69AEF71980', 'edit_sub_items', 'Edit sub items access rights for specification', 'o', 'project', 'specification_details', 'edit_sub_items', 1, getdate(), 1, NULL, 1, 'Edit Sub Items in Specification', NULL)
                       )
