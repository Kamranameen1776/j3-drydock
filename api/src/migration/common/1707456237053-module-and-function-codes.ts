...
export class moduleAndFunctionCodes1707456237053 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        try {
            ...
            VALUES
                ...
                (@maxfunction_id+1, N'EA4184D7-8E4B-4898-873B-F4FE9800E499', N'project', N'project_template_index', N'Project Template', 1, getdate(), NULL, NULL, 1, N'project', N'project_main', N'projtemplate')
                )
