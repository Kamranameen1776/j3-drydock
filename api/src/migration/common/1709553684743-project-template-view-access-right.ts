...
export class projectTemplateViewAccessRight1709553684743 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        try {
            ...
            Begin
                ...
                USING (
				VALUES
					(N'5F5426A7-729E-4C13-A30A-BF4305160883', @jibeAdminRoleId, NULL, N'view_project_template_main', 1, getdate(), NULL, NULL, 1),
					(N'C9AF625C-6BD2-498B-BEAD-322053EFFB78', @jibeAdminRoleId, NULL, N'delete_project_template', 1, getdate(), NULL, NULL, 1),
					(N'EE56E8CF-F7A5-4679-AA6F-9DB63C22C3DA', @jibeAdminRoleId, NULL, N'edit_project_template', 1, getdate(), NULL, NULL, 1)
				)
                    AS SOURCE ([RGR_UID], [RGR_Role_ID], [RGR_Right_Code], [RGR_Group_Code], [Created_By], [Date_Of_Creation],
                                [Modified_By],
                                [Date_Of_Modification], [Active_Status])
