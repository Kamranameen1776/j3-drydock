            ...
            ----------------------------------------------Insert 'Dry Dock' details in jms_dtl_workflow_config table--------------------------------------
                ...
                BEGIN
                    ...
                    BEGIN
                        ...
                        VALUES
                            (1, 'RAISE', 'Planned', 'Create New', 0, 0, null,'["proj_drd_raise_office"]'),
                            (2, 'IN PROGRESS', 'Yard Selection', 'Yard Selection', 1, 0, 1,'["proj_drd_in_progress_office"]'),
                            (3, 'COMPLETE', 'Execution', 'Execution', 1, 1, 1,'["proj_drd_complete_office"]'),
                            (4, 'VERIFY', 'Reporting', 'Reporting', 1, 0, 1,'["proj_drd_verify_office"]'),
                            (5, 'REVIEW', NULL, NULL, 0, 0, 1,'["proj_drd_review_office"]'),
                            (6, 'APPROVE', NULL, NULL, 0, 0, 1, '["proj_drd_approve_office"]'),
                            (7, 'CLOSE', 'Close', 'Closed', 1, 1, 1,'["proj_drd_close_office"]'),
                            (8, 'UNCLOSE', 'Reopen', 'N/A', 1, 0, 1,'["proj_drd_unclose_office"]')
                                        ...
                                        BEGIN
                                            BEGIN TRY
                                                ...
                                                IF(@Config_Details_Id > 0)
                                                    ...
                                                    BEGIN
                                                    Set @Active_Status = 1
                                                    SET @right_code='["proj_drd_raise_office"]'
                                                    END
                                                    ELSE IF (@Is_Office =0)
                                                    BEGIN
                                                    Set @Active_Status = 0
                                                    SET @right_code='["proj_drd_raise_vessel"]'
                                                    END
