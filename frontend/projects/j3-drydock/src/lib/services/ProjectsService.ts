...
import { ApiRequestService, eApiBase, eCrud, eEntities, UserRightsService, WebApiRequest } from 'jibe-components';
...
export class ProjectsService {
  ...
  exportExcel(projectId: string, yardId: string): Observable<Blob> {
    return this.api.getFile('yards/download-yard-invoice', `ProjectUid=${projectId}&YardUid=${yardId}`, null, null, eApiBase.DryDockApi);
  }
