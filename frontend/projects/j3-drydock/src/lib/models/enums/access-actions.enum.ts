...
export enum eSpecificationAccessActions {
  viewSpecificationDetail = 'view_specification_detail',
  viewGeneralInformationSection = 'view_general_information_section',
  ...
  viewSpecificationDetailOnboard = 'view_specification_detail_onboard',
  viewGeneralInformationSectionOnboard = 'view_general_information_section_onboard',
  viewRequisitionSectionOnboard = 'view_requisition_section_onboard',
  ...
  viewAttachmentsSectionOnboard = 'view_attachments_section_onboard',
  ...
  editGeneralInformationOnboard = 'edit_general_information_onboard',
  ...
  deleteSpecificationDetailOnboard = 'delete_specification_detail_onboard',
