...
import { CreateNewExampleProjectDto } from '../../../../infrastructure-layer/api-services/example-projects/dtos/CreateNewExampleProjectDto';
...
export class CreateExampleProjectPopupComponent implements OnInit {
  ...
  async createExampleProject(): Promise<void> {
    ...
    const createExampleCloseResultDto = new CreateNewExampleProjectDto();
    createExampleCloseResultDto.Name = exampleProjectName;

    // Create new project
    const createdProject = await this.exampleProjectsService.createNewExampleProject(createExampleCloseResultDto);
